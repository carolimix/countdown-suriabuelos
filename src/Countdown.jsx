...
export const Countdown = () => {
  ...
  const [inputDate, setInputeDate] = useState("22 July 2023");
  ...
  const onChangeHandler = (event) => {
    setInputeDate(event.target.value);
  };
  ...
  return (
    <div className='countdown-container'>
      ...
      <div className='countdown-input-button'>
        ...
        <button className='cowntdown-button' onClick={onClickHandler}>
          Countdown
        </button>
      </div>
    </div>
